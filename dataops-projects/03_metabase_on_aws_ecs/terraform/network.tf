...
# Each private subnet keeps its own (locally-scoped) route table, matching
# the source environment where private subnets have no route to the internet.
